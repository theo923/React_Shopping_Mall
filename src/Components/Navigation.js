    ...
    return (React.createElement("div", { className: "navbar mb-2 shadow-lg bg-neutral text-neutral-content rounded-box" },
        React.createElement("div", { className: "flex-1 px-0 mx-0 lg:px-2 lg:mx-2 " },
            React.createElement("div", { className: "items-stretch flex" },
                ...
                React.createElement("button", { name: 'page', value: 'shoppingCart', className: "btn btn-ghost btn-sm rounded-btn", onClick: function (e) { return handleChange(e); } }, "Cart"),
                React.createElement("button", { name: 'page', value: 'tracking', className: "btn btn-ghost btn-sm rounded-btn", onClick: function (e) { return handleChange(e); } }, "Track"),
